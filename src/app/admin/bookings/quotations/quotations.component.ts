...
import { apiResultFormat, quotation } from '../../../shared/services/model/model';
...
export class QuotationsComponent {
 public routes = routes;
  ...
  initChecked=false;
  public pageSize = 10;
  public tableData: quotation[] = [];
  public tableDataCopy: quotation[] = [];
  public actualData: quotation[] = [];
  ...
  constructor(
    ...
    this.data.getQuotation().subscribe((apiRes: apiResultFormat) => {
      ...
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == '/admin/quotations') {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getQuotation().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: quotation, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<quotation>(this.actualData);
