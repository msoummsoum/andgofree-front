...
import { apiResultFormat, categories } from '../../../../shared/services/model/model';
...
initChecked=false;
  public pageSize = 10;
  public tableData: categories[] = [];
  public tableDataCopy: categories[] = [];
  public actualData: categories[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getCategories().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<categories>(this.actualData);
