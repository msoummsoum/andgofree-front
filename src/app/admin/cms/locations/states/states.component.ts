...
import { apiResultFormat, state } from '../../../../shared/services/model/model';
...
initChecked=false;
  public pageSize = 10;
  public tableData: state[] = [];
  public tableDataCopy: state[] = [];
  public actualData: state[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getState().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<state>(this.actualData);
