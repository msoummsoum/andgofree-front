...
import { apiResultFormat, ticket } from '../../../shared/services/model/model';
...
@Component({
  ...
  imports: [NgxEditorModule,MatSelectModule,CustomPaginationComponent,CommonModule,RouterLink,MatSort,FormsModule],
...
initChecked=false;
  ...
  public tableDataCopy: ticket[] = [];
  public actualData: ticket[] = [];
  ...
  constructor(
    ...
    this.data.getTicket().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.tickets) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getTicket().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: ticket, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<ticket>(this.actualData);
