...
@Component({
  ...
  styleUrl: './safety-features.component.scss'
})
export class SafetyFeaturesComponent {
  routes=routes
...
constructor(
  ...
  this.data.getSafetyFeature().subscribe((apiRes: apiResultFormat) => {
    this.actualData = apiRes.data;
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.safetyFeatures) {
