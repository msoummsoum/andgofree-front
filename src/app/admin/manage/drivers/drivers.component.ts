...
import { apiResultFormat, driver } from '../../../shared/services/model/model';
...
initChecked=false;
public pageSize = 10;
public tableData: driver[] = [];
public tableDataCopy: driver[] = [];
public actualData: driver[] = [];
...
constructor(
  ...
  this.data.getDriver().subscribe((apiRes: apiResultFormat) => {
    this.actualData = apiRes.data;
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.drivers) {
...
private getTableData(pageOption: pageSelection): void {
  this.data.getDriver().subscribe((apiRes: apiResultFormat) => {
    ...
    apiRes.data.map((res: driver, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<driver>(this.actualData);
