...
import { apiResultFormat, role } from '../../../shared/services/model/model';
...
@Component({
  ...
  imports: [CustomPaginationComponent,RouterLink,CommonModule,MatSort,FormsModule],
...
initChecked=false;
  ...
  public tableDataCopy: role[] = [];
  public actualData: role[] = [];
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getRole().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<role>(this.actualData);
